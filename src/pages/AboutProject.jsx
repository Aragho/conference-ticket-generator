...
export default function AboutProject() {
  return (
    <div className="w-full max-w-2xl border border-[#072e35] mt-6 rounded-3xl p-6 shadow-lg text-white">
      <h3>Event Ticket Booking UI – Open Source Practice Project 🎟️
